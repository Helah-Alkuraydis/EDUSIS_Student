...
export const attendanceData = [
  {
    id: 1,
    subject: "أساسيات التصميم الجرافيكي",
    date: "2024-01-25",
    time: "10:00 AM",
    status: "حاضر",
  },
  ...
  {
    id: 6,
    subject: "نظرية الألوان وتطبيقاتها",
    date: "2024-01-25",
    time: "02:15 PM",
    status: "لم تبدأ",
  },
...
export const subjects = [
    ...
    advisor: "غير محدد",
    subjects: [
      "مبادئ التحليل الكمي - 1",
      "المهارات الجامعية",
      "الخبرة - 2"
    ]
  },
  {
    course: "اقتصاد وادارة - غير محدد",
    batch: "441",
    registrationNumber: "2",
    advisor: "غير محدد",
    subjects: [
      "مبادئ الإدارة والتنظيم",
      "مبادئ اقتصادية متنوعة",
      "المهارات اللغوية",
      "المدخل إلى الثقافة الإسلامية",
      "مقدمة في التقنية",
      "الرياضيات في العلوم الاجتماعية - 1",
      "الرياضيات في العلوم الاجتماعية - 2",
      "مبادئ الاقتصاد الكلي",
      "مقدمة في تطبيقات الحاسب",
      "الإحصاء في الإحصاء والإدارة - 1",
      "مبادئ التسويق",
      "نظام المجتمع - محاسبة",
      "المبادئ المالية",
      "الإحصاء في الإحصاء والإدارة - 2",
