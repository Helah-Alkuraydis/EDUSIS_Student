  ...
  return (
    <>
      <div className="flex items-center gap-6 justify-start mt-5 "> 
        ...
        <div className="flex items-center gap-6 justify-start w-screen  mb-6">
          <div className='gap-6 flex'>
            ...
            <div className=' rounded-md w-10 h-10 flex items-center justify-center cursor-pointer  hover:bg-gray-500/10'>
      ...
      <div className="hidden md:flex  gap-20 justify-between rounded-2xl bg-grad-horizontal  ">
